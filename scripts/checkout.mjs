import { cart, removeFromCart, updateDeliveryOptions } from "../data/carts.js";
...
function refreshCartpage() {
    ...
    cart.forEach(cartItem => {
        ...
        const matchingProduct = products.find((item) => item.id === cartItem.productId);
    
        cartSummary += `
        <div class="cart-item-container js-cart-item-container-${matchingProduct.id}">
                <div class="delivery-date">
                  Delivery date: ${cartItem.deliveryOptionId}
                </div>
    ...
    document.querySelectorAll(".js-delete-quantity-link").forEach(link => {
        link.addEventListener('click', () => {
            ...
            if(currentQuantity === 1) {
                ...
                document.querySelector(`.js-quantity-label-${productId}`).innerHTML = currentQuantity - 1;
            }
